...
async def shuffle_file(path: str) -> None:
    print("TODO: corrutina por hacer")


async def main(directory: Path) -> None:
    tasks = [shuffle_file(f) for f in directory.iterdir() if f.is_file()]
    # TODO completa esta corrutina para lanzar todas las tareas de
    #      forma asíncrona usando la función gather de asyncio.
