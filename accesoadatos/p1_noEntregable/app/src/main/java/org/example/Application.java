...
import org.example.UsuarioDBRepository;
import org.example.data.IUsuarioRepository;
...
public class Application extends javafx.application.Application {
    ...
    public String getConnectionString() {
        ...
        try (FileInputStream fis = new FileInputStream("app.properties")) {
            ...
            System.err.println(
                "No se pudo leer el archivo de propiedades: " + e.getMessage()
            );
        }
    ...
    public void start(Stage stage) throws IOException {
        IUsuarioRepository repository = new UsuarioDBRepository(
