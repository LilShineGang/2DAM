...
import org.example.IUsuarioRepository;
...
public class AppController {
    ...
    public void setRepository(final IUsuarioRepository irepository) {
        ...
        List<Usuario> tempo = this.repository.listaUsuarios()
            .stream()
            .map(usuario -> {
                String decrypt = this.encryptor.decrypt(
    ...
    public void onGuardarUsuario(ActionEvent actionEvent) {
        if (selected == null) {
            ...
            this.selected.setContrasenya(
                this.encryptor.encrypt(txtContrasena.getText())
            );
